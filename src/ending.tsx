...
export const EndingAnimation: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      {frame > 30 && (
          <Animated animations={[Move({ initialX: -80, y: 90, start: 30, duration: 10 })]} >
      ...
      {frame > 20 && (
        <>
          <Animated animations={[Move({ initialX: -80, y: 60, start: 20, duration: 10 })]} >
            <h1 style={{ position: 'absolute', bottom: 580, fontSize: '48px', background:'white', paddingTop: '10px'}}>
              WEEKLY
            </h1>
          </Animated>
          <Animated animations={[Move({ initialX: 145, y: 60, start: 20, duration: 10 })]} >
